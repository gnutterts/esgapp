...
<div class="max-w-2xl mx-auto px-4 py-20 text-center">
    <h1 class="text-6xl font-bold text-navy dark:text-white mb-4">404</h1>
    <p class="text-xl text-gray-600 dark:text-gray-400 mb-8">De pagina die je zoekt bestaat niet.</p>
    <a href="{{ route('home') }}"
